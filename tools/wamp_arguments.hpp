...
static const msgpack::object EMPTY_ARGUMENTS(std::array<msgpack::object, 0>(), [] { static msgpack::zone z; return &z; }());
static const msgpack::object EMPTY_KW_ARGUMENTS(wamp_kw_arguments(), [] { static msgpack::zone z; return &z; }());
