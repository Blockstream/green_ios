...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        const auto send_request = rpc.make_send_to_address(address_1.get_address(), "2");
        ...
        std::cerr << address_2.get_address() << std::endl;
        const std::string addr = address_2.get_address();
#if 0
...
#endif
        session_1.send(0, { { addr, sdk::amount{ 100000 } } }, sdk::amount{ 1000 }, false);
