...
class SendAddressInputViewController: KeyboardViewController {
    ...
    func presentQrScannerViewController() {
        ...
        if let vc = storyboard.instantiateViewController(withIdentifier: "QrScannerViewController") as? QrScannerViewController {
...
extension SendAddressInputViewController: QrScannerViewControllerDelegate {
