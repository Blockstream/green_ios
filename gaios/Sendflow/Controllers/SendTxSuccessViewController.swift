...
protocol SendTxSuccessViewControllerDelegate: AnyObject {
    func onDone()
    func onShare()
}

class SendTxSuccessViewController: UIViewController {
    ...
    weak var delegate: SendTxSuccessViewControllerDelegate!
