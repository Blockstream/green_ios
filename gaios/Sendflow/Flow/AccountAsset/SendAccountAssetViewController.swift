...
class SendAccountAssetViewController: UIViewController {
    ...
    private let viewModel: SendAccountAssetViewModel

    init?(coder: NSCoder, viewModel: SendAccountAssetViewModel) {
...
extension SendAccountAssetViewController: UITableViewDelegate, UITableViewDataSource {
        ...
        case .accountAsset:
            if let cell = tableView.dequeueReusableCell(withIdentifier: AccountAssetCell.identifier, for: indexPath) as? AccountAssetCell {
                ...
                cell.configure(model: model,
                               useValidate: UseValidate.satoshi(model.balance),
                               onTap: { [weak self] in
...
extension SendAccountAssetViewController {
...
extension SendAccountAssetViewController: SendFlowErrorDisplayable {
