...
enum SetupNewMoreActions: CaseIterable {
    case watchonly
    var title: String {
        switch self {
        case .watchonly:
...
protocol SetupNewMoreActionsViewControllerDelegate: AnyObject {
    func didSelectAction(_ indexPath: IndexPath)
}

class SetupNewMoreActionsViewController: UIViewController {
    ...
    weak var delegate: SetupNewMoreActionsViewControllerDelegate?

    var viewModel: SetupNewMoreActionsViewModel!
...
extension SetupNewMoreActionsViewController: UITableViewDelegate, UITableViewDataSource {
