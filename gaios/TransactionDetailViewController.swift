...
class TransactionDetailViewController: KeyboardViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        viewInExplorerButton.applyGradient(colours: [UIColor.customMatrixGreen(), UIColor.customMatrixGreenDark()])
    }
...
class TransactionTableViewController: UITableViewController, UITextViewDelegate {
    ...
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        walletGradientView.applyCardGradient()
    }
    ...
    func updateUI() {
        ...
        if transaction.type == "redeposit" {
            ...
            recipientLabel.text = transaction.addressees.map{$0.address}.joined(separator: " ")
            walletCell.isHidden = true
        }
