...
#define SDK_FN_B33_BS(F)                                                                                               \
    ...
    inline void F(const I1& i1, uint32_t i321, uint32_t i322, O& out, size_t* written = 0)                             \
    {                                                                                                                  \
...
#define SDK_FN_B3_BS(F)                                                                                                \
    template <class I1, class O> inline void F(const I1& i1, uint32_t i321, O& out, size_t* written = 0)               \
    {                                                                                                                  \
...
#define SDK_FN_BB3_BS(F)                                                                                               \
    template <class I1, class I2, class O>                                                                             \
    inline void F(const I1& i1, const I2& i2, uint32_t i321, O& out, size_t* written = 0)                              \
    {                                                                                                                  \
...
#define SDK_FN_BBB3_BS(F)                                                                                              \
    ...
    inline void F(const I1& i1, const I2& i2, const I3& i3, uint32_t i321, O& out, size_t* written = 0)                \
    {                                                                                                                  \
...
#define SDK_FN_BB_BS(F)                                                                                                \
    template <class I1, class I2, class O> inline void F(const I1& i1, const I2& i2, O& out, size_t* written = 0)      \
    {                                                                                                                  \
...
#define SDK_FN_B_BS(F)                                                                                                 \
    template <class I, class O> inline void F(const I& i1, O& out, size_t* written = 0)                                \
    {                                                                                                                  \
...
#define SDK_FN_B_S(F)                                                                                                  \
    template <class I> inline void F(const I& i1, size_t* written) { GA_SDK_VERIFY(wally::F(i1, written)); }
...
#define SDK_FN_P3_BS(F)                                                                                                \
    template <class P1, class O> inline void F(const P1& p1, uint32_t i321, O& out, size_t* written = 0)               \
    {                                                                                                                  \
        GA_SDK_VERIFY(wally::F(p1, i321, out, written));                                                               \
    }

#define SDK_FN_P3_S(F)                                                                                                 \
    template <class P1> inline void F(const P1& p1, uint32_t i321, size_t* written)                                    \
    {                                                                                                                  \
...
#define SDK_FN_PP3_BS(F)                                                                                               \
    template <class P1, class P2, class O> inline void F(const P1& p1, const P2& p2, O& out, size_t* written = 0)      \
    {                                                                                                                  \
...
#define SDK_FN_P_BS(F)                                                                                                 \
    template <class P1, class O> inline void F(const P1& p1, O& out, size_t* written = 0)                              \
    {                                                                                                                  \
        GA_SDK_VERIFY(wally::F(p1, out, written));                                                                     \
    }

#define SDK_FN_P_S(F)                                                                                                  \
    template <class P1> inline void F(const P1& p1, size_t* written) { GA_SDK_VERIFY(wally::F(p1, written)); }
